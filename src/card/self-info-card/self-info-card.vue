                ...
                <ul class="items">
                    <li>
                        <div role="setting" class="panel-item">
                            <i class="iconfont icon-edit"><i class="el-icon-edit"></i></i>编辑资料
                        </div>
                    </li>
                    <li>
                        <div role="destroy" class="panel-item">
                            <i class="iconfont icon-delete"><i class="el-icon-delete"></i></i>离职申请
                        </div>
                    </li>
                    <li>
                        <div role="move" class="panel-item">
                            <i class="iconfont icon-add"><i class="el-icon-plus"></i></i>注销账号
                        </div>
                    </li>
                </ul>
